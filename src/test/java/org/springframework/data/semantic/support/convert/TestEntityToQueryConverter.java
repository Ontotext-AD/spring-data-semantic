...
public class TestEntityToQueryConverter {
	private String expectedBindings = "<http://ontotext.com/resource/test> a <urn:sprind-data-semantic:ModelEntity> . <http://ontotext.com/resource/test> <urn:field:name> ?modelentity_name . <http://ontotext.com/resource/test> <urn:field:related> ?modelentity_related . ";
