 ...
 */
public class FilteringSemanticRepositoryFactory extends SemanticRepositoryFactory {

	public FilteringSemanticRepositoryFactory(SemanticOperationsCRUD operations) {
		super(operations);
	}

	@Override protected Class<?> getRepositoryBaseClass(RepositoryMetadata metadata) {
		return FilteringSemanticRepositoryImpl.class;
	}
	...
	protected Object getTargetRepository(RepositoryMetadata metadata) {
		...
		return new FilteringSemanticRepositoryImpl(operations, type);
	}
